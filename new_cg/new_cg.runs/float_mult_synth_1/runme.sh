...
HD_PWD='D:/mygit/new_CG/new_cg/new_cg.runs/float_mult_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_mult.vds -m64 -mode batch -messageDb vivado.pb -notrace -source float_mult.tcl
