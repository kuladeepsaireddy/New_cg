...
HD_PWD='D:/mygit/new_CG/new_cg/new_cg.runs/float_add_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_add.vds -m64 -mode batch -messageDb vivado.pb -notrace -source float_add.tcl
