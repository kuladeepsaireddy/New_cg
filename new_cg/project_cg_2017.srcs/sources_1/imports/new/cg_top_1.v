...
input i_ready_sol,
output reg o_valid,
(*dont_touch="true"*) output reg [31:0] iter_num,
input [31:0]req_iter,
...
reg  count;
(*dont_touch="true"*) reg [`n_size-1:0] op_counter;
(*dont_touch="true"*) reg [`n_size-1:0] op_counter_1;
(*dont_touch="true"*) reg [`n_size-1:0] op_counter_2;
(*dont_touch="true"*) reg [`n_size-1:0] op_counter_3;
(*dont_touch="true"*) reg [`n_size-1:0] op_counter_4;
(*dont_touch="true"*) reg [`n_size-1:0] op_counter_5;
...
(*dont_touch="true"*) reg i_ready_mat_mult;
...
(*dont_touch="true"*) reg i_data_scalar_valid_1;
wire o_ready_1_1;
wire o_ready_2_1;
wire o_ready_scalar_1;
wire [31:0] o_data_1;
wire o_valid_1;
(*dont_touch="true"*) reg i_ready_1;
...
(*dont_touch="true"*) reg i_data_scalar_valid_2;
wire o_ready_1_2;
wire o_ready_2_2;
wire o_ready_scalar_2;
wire [31:0] o_data_2;
wire o_valid_2;
(*dont_touch="true"*) reg i_ready_2;
...
(*dont_touch="true"*) reg i_ready_result_reci;
wire [31:0]o_data_result_reci;

(*dont_touch="true"*) reg [`n_size:0] wr_addr;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_2;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_3;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_4;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_5;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_6;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_8;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_9;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_r;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_x;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_q;
...
reg flag_beta;
reg final_flag;
(*dont_touch="true"*) reg [`n_size-1:0]sol_reg;
