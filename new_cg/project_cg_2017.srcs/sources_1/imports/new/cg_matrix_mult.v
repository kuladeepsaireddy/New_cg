...
(*dont_touch="true"*) reg [`n_size:0] wr_addr_left;
(*dont_touch="true"*) reg [`n_size:0]  wr_addr_right;
(*dont_touch="true"*) reg [`n_size:0]  wr_addr_top;
(*dont_touch="true"*) reg [`n_size:0] wr_addr_bottom;
...
(*dont_touch="true"*) reg i_valid_1_add_2;
wire o_ready_1_add_2;
(*dont_touch="true"*) reg i_valid_2_add_2;
...
wire  i_valid_2_mult;
wire o_ready_2_mult;
(*dont_touch="true"*) reg  [31:0] i_data_2_mult;
 ...
 if(end_sig)
  begin
   ...
   begin
	...
	////////////////////////////////////////////////////////////////////////////
   else if(i==`s_x_count & j!=1 & j!=`s_y_count)
    begin
	    if(o_ready_1_mult & o_ready_2_add_1 & o_ready_1_add_2 & o_ready_2_add_2)
 		 begin
          i_valid_1_mult<=1'b1;	  
   ...
   else if(i==`s_x_count & j==`s_y_count)
    begin
	    if(o_ready_1_mult & o_ready_2_add_1 & o_ready_1_add_2 & o_ready_2_add_2)
 		 begin
          i_valid_1_mult<=1'b1;	  
   ...
   else if(j==`s_y_count& i!=1 &i!=`s_x_count)
    begin
	   if(o_ready_1_mult & o_ready_2_add_1 & o_ready_1_add_2 & o_ready_2_add_2)
 		 begin
          i_valid_1_mult<=1'b1;	  
...
//assign i_data_2_mult = (end_sig ==1)?0:(o_ready_2_mult==1)? 32'h40800000:0;
