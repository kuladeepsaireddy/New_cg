...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../new_cg.srcs/sources_1/ip/float_add/sim/float_add.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.float_add $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.float_add -input simulate.do
}
# Script usage
usage()
{
