...
#
# Generated by Vivado on Mon Jul 03 15:09:08 +0530 2017
...
# Script info
echo -e "float_mult.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./float_mult.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../new_cg.srcs/sources_1/ip/float_mult/sim/float_mult.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.float_mult $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.float_mult -input simulate.do
}
# Script usage
usage()
{
